...
;; In Emacs 22, you should use Korean font names for korean fonts like "³ª´®°íµñ_AndaleMono" for things to go well,
...
(condition-case nil
    (if (eq window-system 'w32)
        (progn
          ...
          (create-fontset-from-fontset-spec
           "-*-Andale Mono-normal-r-*-*-12-*-*-*-c-*-fontset-andalemono,
 	 ascii:-*-Andale Mono-normal-r-*-*-12-*-*-*-c-*-iso8859-1,
	 korean-ksc5601:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-12-*-*-*-c-*-ksc5601.1987*-*,
 	 ...
 	 chinese-big5-2:-*-MingLiU-normal-r-*-*-12-*-*-*-c-*-big5-*"
          ...
          (create-fontset-from-fontset-spec
           "-*-Andale Mono-normal-r-*-*-13-*-*-*-c-*-fontset-andalemono13,
 	 ascii:-*-Andale Mono-normal-r-*-*-13-*-*-*-c-*-iso8859-1,
	 korean-ksc5601:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-ksc5601.1987*-*,
 	 katakana-jisx0201:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-jisx0208-sjis,
 	 japanese-jisx0208:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-jisx0208-sjis,
 	 japanese-jisx0212:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-jisx0212-sjis,
  	 chinese-gb2312:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-gb2312-*,
  	 chinese-big5-1:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-big5-*,
 	 chinese-big5-2:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-big5-*"
           t)

          (create-fontset-from-fontset-spec
           "-*-Andale Mono-normal-r-*-*-12-*-*-*-c-*-fontset-mscourier12c,
 	 ascii:-*-Andale Mono-normal-r-*-*-12-*-*-*-c-*-iso8859-1,
         korean-ksc5601:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-13-*-*-*-c-*-ksc5601.1987*-*,
 	 ...
 	 chinese-big5-2:-*-MingLiU-normal-r-*-*-13-*-*-*-c-*-big5-*"
          ...
          (create-fontset-from-fontset-spec
           "-*-Andale Mono-normal-r-*-*-12-*-*-*-c-*-fontset-mscourier12,
 	 ascii:-*-Andale Mono-normal-r-*-*-12-*-*-*-c-*-iso8859-1,
	 korean-ksc5601:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-12-*-*-*-c-*-ksc5601.1987*-*,
 	 katakana-jisx0201:-*-MS Gothic-normal-r-*-*-12-*-*-*-c-*-jisx0208-sjis,
 	 japanese-jisx0208:-*-MS Gothic-normal-r-*-*-12-*-*-*-c-*-jisx0208-sjis,
 	 ...
 	 chinese-big5-2:-*-MingLiU-normal-r-*-*-12-*-*-*-c-*-big5-*"
          ...
          (create-fontset-from-fontset-spec
           "-*-Andale Mono-normal-r-*-*-16-*-*-*-c-*-fontset-mscourier16c,
 	 ascii:-*-Andale Mono-normal-r-*-*-16-*-*-*-c-*-iso8859-1,
	 korean-ksc5601:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-20-*-*-*-c-*-ksc5601.1987*-*,
 	 ...
 	 chinese-big5-2:-*-MingLiU-normal-r-*-*-20-*-*-*-c-*-big5-*"
          ...
          (create-fontset-from-fontset-spec
           "-*-Andale Mono-normal-r-*-*-16-*-*-*-c-*-fontset-mscourier16,
 	 ascii:-*-Andale Mono-normal-r-*-*-16-*-*-*-c-*-iso8859-1,
	 korean-ksc5601:-*-³ª´®°íµñ_AndaleMono-normal-r-*-*-16-*-*-*-c-*-ksc5601.1987*-*,
 	 ...
 	 chinese-big5-2:-*-MingLiU-normal-r-*-*-16-*-*-*-c-*-big5-*"
          ...
          (setq default-frame-alist
                (append '(
                          ;; Choose only one for your default font set.
                          ;;(font . "-*-Andale Mono-normal-r-*-*-13-*-*-*-c-*-fontset-standard")
                          ;;(font . "-*-Andale Mono-normal-r-*-*-16-*-*-*-c-*-fontset-most")
                          ;;(font . "fontset-mscourier12c")
                          (font . "fontset-andalemono13")
...
;; caution!: ¹æ¹®ÇÑ µð·ºÅä¸®¸¶´Ù semantic.cache ÆÄÀÏÀ» ³²±â´Â ¹®Á¦°¡ ÀÖÀ½.
;(condition-case nil
;    (require 'jde)
;  (error nil))
